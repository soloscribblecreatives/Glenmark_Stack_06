...
switch(pg_id){
	...
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/1.jpg" width="1024" height="768" alt=""></div><div class="video1"><video class="popup1" id="popup1" controls><source src="slide2/PIO & CV protection- PROACTIVE & IRIS.mp4" type="video/mp4"></video></div><div class="pop_open1" onclick="pop_open1()"></div><div class="video2"><video class="popup1" id="popup2" controls><source src="slide2/PIO Side effects- 2- HEART FAILURE & FLUID RETENTION.mp4" type="video/mp4"></video></div><div class="pop_open2" onclick="pop_open2()"></div><div class="pop_close" onclick="pop_close();pop_close1();pop_close2();"><img src="slide2/cross.png"></div>';
	break;
	case 3:
