...
switch(pg_id){
	...
	break;
	case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide1.css" media="screen"/><div class="background"><img src="slide3/1.jpg" width="1024" height="768" alt=""></div><object class="popup" data="slide1/home_study.pdf" height="768" width="1024"></object><div class="pop_open" onclick="pop_open()"></div><div class="pop_close" onclick="pop_close()"><img src="slide1/3.png"></div>';
	break;
	case 4:
	content='<link rel="stylesheet" type="text/css" href="slide4/slide1.css" media="screen"/><div class="background"><img src="slide4/1.jpg" width="1024" height="768" alt=""></div><object class="popup" data="slide1/boat_study.pdf" height="768" width="1024"></object><div class="pop_open" onclick="pop_open()"></div><div class="pop_close" onclick="pop_close()"><img src="slide1/3.png"></div><object class="popup1" data="slide1/arota_study.pdf" height="768" width="1024"></object><div class="pop_open1" onclick="pop_open1()"></div><div class="pop_close1" onclick="pop_close1()"><img src="slide1/3.png"></div>';
	break;
	case 5:
	...
	break;
	case 6:
	content='<link rel="stylesheet" type="text/css" href="slide6/slide1.css" media="screen"/><div class="background"><img src="slide6/1.jpg" width="1024" height="768" alt=""></div>';
	break;
	case 7:
	content='<link rel="stylesheet" type="text/css" href="slide7/slide1.css" media="screen"/><div class="background"><img src="slide7/1.jpg" width="1024" height="768" alt=""></div><div class="popup"><img src="slide7/2.jpg" width="1024" height="768" alt=""></div><div class="pop_open" onclick="pop_open()"></div><div class="pop_close" onclick="pop_close()"></div><div class="popup1"><img src="slide7/3.jpg" width="1024" height="768" alt=""></div><div class="pop_open1" onclick="pop_open1()"></div><div class="pop_close1" onclick="pop_close1()"></div>';
	break;
}
